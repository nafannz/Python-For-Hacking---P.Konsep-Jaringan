...
| -------- | ---------------------------- | ------------------ | ------------------- | ------------------ | --------------------- |
| **TCP**  | Pengiriman data aplikasi     | Reliable           | Connection-oriented | Lebih lambat       | Web, Email, File      |
| **UDP**  | Pengiriman data cepat        | Unreliable         | Connectionless      | Sangat cepat       | Streaming, VoIP, Game |
| **BGP**  | Routing antar jaringan besar | Reliable (via TCP) | Connection-oriented | Lambat tapi stabil | ISP, router internet  |
